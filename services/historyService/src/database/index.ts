  ...
  await db.collection('submissions').insertMany([
    {
      ...
      "categories": ["Array", "Hash Table"], // ✓ Added categories
    ...
    },
    {
      ...
      "categories": ["Array", "Divide and Conquer", "Sorting", "Heap (Priority Queue)", "Quickselect"], // ✓ Added categories
    ...
    },
    {
      ...
      "categories": ["String", "Dynamic Programming"], // ✓ Added categories
    ...
    },
    {
      ...
      "categories": ["Array", "Binary Search"], // ✓ Added categories
    ...
    },
    {
      ...
      "categories": ["Array", "Dynamic Programming", "Greedy"], // ✓ Added categories
    ...
    },
    {
      ...
      "categories": ["Array", "Depth-First Search", "Breadth-First Search", "Union Find", "Matrix"], // ✓ Added categories
    ...
    },
    {
      ...
      "categories": ["Array", "Two Pointers", "Dynamic Programming", "Stack", "Monotonic Stack"], // ✓ Added categories
    ...
    },
    {
      ...
      "categories": ["Array", "Bit Manipulation", "Enumeration"], // ✓ Added categories
