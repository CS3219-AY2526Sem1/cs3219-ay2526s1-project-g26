...
- User 2: Topics [Graphs], Difficulty [Easy], Waiting Time 150s (2min 45s)
...
### Scenario 3: No Match (No overlap Topics)
...
### Scenario 4: No Match (No overlap Difficulty with short wait time)
